#!/bin/sh
test ! -d ../Cead && git clone https://github.com/TotkMods/Cead --depth 1 --recursive
test ! -d ../cs-restbl && git clone https://github.com/EPD-Libraries/cs-restbl --depth 1 --recursive

for i in ../Cead ../cs-restbl; do
